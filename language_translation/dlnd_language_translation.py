...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    source_id_text = [[source_vocab_to_int[t] for t in word.split()] for word in source_text.split('\n')]
    target_id_text = [[target_vocab_to_int[t] for t in word.split()] + [target_vocab_to_int['<EOS>']] for word in target_text.split('\n')]
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    word_id = [vocab_to_int[word] if word in vocab_to_int else vocab_to_int['<UNK>'] for word in sentence.split()]
    return word_id
